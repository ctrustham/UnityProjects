...
public class Manager : MonoBehaviour {
    ...
    private void CreateBoomerangBodies()
    {
        ...
        for (int i = 0; i < populationSize; i++)
        {
            Boomerang boomer = Instantiate(boomerPrefab, new Vector3(Random.Range(-10f, 10f), UnityEngine.Random.Range(-10f, 10f), 0), boomerPrefab.transform.rotation).GetComponent<Boomerang>();
